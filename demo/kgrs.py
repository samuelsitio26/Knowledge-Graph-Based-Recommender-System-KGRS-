...
class Dataloader:
    ...
    def _convert_kg(self, lines):
        ...
        kg = []
        rel_dict = {}
        # relation2id.txt is located in the same folder as this file (demo/)
        rel_path = os.path.join(os.path.dirname(__file__), 'relation2id.txt')
        for line in open(rel_path, encoding='utf8').readlines():
...
class KGRS:
    def __init__(
        ...
        """
        # Config (defaults + optional overrides)
        default_config = {
            "batch_size": 256,
